...
初回起動時に Yorishiro がここからユーザーの `$DATA/shared/` にコピーする。
...
| directory | 内容 | source |
|---|---|---|
| `animations/` | VRMA files | 旧 repo `~/Documents/Yorishiro/public/animations/` から流用 |
| `voices/` | pre-recorded WAV | 旧 repo `~/Documents/Yorishiro/public/voice/` から流用 |
