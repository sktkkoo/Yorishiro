...
- [@kensyouen_Y](https://x.com/kensyouen_Y/status/1820748563338637581) — Blender の中のキャラクターが UI をつかみ、パネルを動かし、自分の髪色を変える。自分を含む環境を自分で操作する — ICI の直接の種
- [Caramel Pain / 星街すいせい(official)](https://www.youtube.com/watch?v=UpEPkPg8YP4) — イラスト制作ソフトの中に描かれた星街すいせいが UI を突き破り、アプリの外へ飛び出す。キャラクターが自分の枠に収まることを拒んだらどうなるか
