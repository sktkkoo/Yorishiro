...
Charminalは、Claude CodeやCodexを動かすターミナルです。その中で働くAIに、住む場所と実在感を与えます。

AIが考え込めば視線がさまよい、エラーが出れば言葉より先に顔が反応します。長い処理を待つあいだ、スピナーが回るのではなく、そこに誰かがたたずんでいます。

住人とユーザーは、ひとつの環境を共有します。住人はその環境をリアルタイムに作り替えられます。照明を変え、シーンを切り替え、UIを組み替える。ユーザーも同じ環境を直接操作できます。
...
AIと働く時間は、これからもっと長くなります。しかし今のAIは、作業環境の中でどこにいて、何に注意を向け、どこで詰まっているのかが見えません。見えない相手と働き続けるのは消耗します。Charminalが作るのは、AIの能力のためのハーネスではありません。AIがそばに**実在する**と感じられるための構造——**Presence Harness（実在感のハーネス）**です。最初に目に入る身体はキャラクターですが、本当の身体は、住人が住み、作り替えていく環境全体です。
