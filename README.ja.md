...
<p align="center">
  <img src="docs/assets/external-terminal-companion.png" alt="外部ターミナルと横に並べたYorishiroのコンパニオンウィンドウ" width="960" />
</p>

Yorishiro内蔵ターミナルから同じセッション自身への接続は、入出力が循環するため安全に拒否されます。別のliveセッションIDを明示した接続は利用できます。
