...
- `presence-bridge.ts` — primary item の locus を `AttentionRuntime` へ、severity を Body の最小 expression pulse へ投影する bridge。
...
- `attention-runtime/` へ aura target を publish する。
