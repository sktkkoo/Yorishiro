...
> 思想層：[docs/philosophy/PHILOSOPHY.md](../../docs/philosophy/PHILOSOPHY.md)（二つの層）
...
| `body/` | VRM character の actuator 層（expression / animation / gaze / blink / breathing / 生理反射 / `packages/yoromeki` への外力 adapter） | impl | `index.ts` |
...
| `two-layer/` | 思考層と反射層を orchestrate する coordinator | **skeleton** | `index.ts` |
