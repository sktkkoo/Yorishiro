...
このドキュメントは Charminal の scene を自分で変える user / pack 作者（あるいはその依頼を受けた AI）が読むためのガイド。**scene を書く前に必ず読む**。
...
（spec §2.3 / feedback memory `feedback_charminal_presence_over_spectacle.md`）
...
```
~/.charminal/packs/scenes/my-room/
