...
| `runtime/surface-registry/` | host 所有の named surface → DOM mount 対応表（"shell" / "character"）。layout / MCP / presence の DOM 解決を querySelector 直依存から名前ベースへ（shell named-surfaces P1） |
