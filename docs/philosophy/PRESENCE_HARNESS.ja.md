...
- **Inhabited Character Interface (ICI)** — UI を住環境として捉え、AI を住人として存在させる。Charminal はこのアプローチ。→ `INHABITED_CHARACTER_INTERFACE.ja.md`
...
Presence Harness ← 本ドキュメント
  └─ 表現のかたち
      ├─ ICI        → INHABITED_CHARACTER_INTERFACE.ja.md
      │   └─ Charminal → CHARMINAL.ja.md
      ├─ Ambient Presence
      └─ Tactile Presence
```
