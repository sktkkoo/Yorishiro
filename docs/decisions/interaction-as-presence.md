...
- 「住人が user に応答する」interaction は presence の根拠（[philosophy/INHABITED_INTERFACE_PHILOSOPHY.md](../philosophy/INHABITED_INTERFACE_PHILOSOPHY.md)）
...
- philosophy: [docs/philosophy/INHABITED_INTERFACE_PHILOSOPHY.md](../philosophy/INHABITED_INTERFACE_PHILOSOPHY.md)「自発性の原則」
