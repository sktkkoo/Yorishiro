...
- A separate upper-body schedule restores the calibrated quiet Idle and reviewed HandOnHip. After 25–45 seconds of quiet eligibility, a compatible, non-repeating candidate plays for 8–12 seconds before an 800 ms return. Supporting legs continue throughout. Semantic retrieval, availability, cooldown and physical entry gates remain in force.
- The finite, safe raised-hand survey remains a separate rare performance. Unsafe Watching and whole Around clips remain excluded. Speech, manual ownership and animation claims take precedence over automatic posture changes.
