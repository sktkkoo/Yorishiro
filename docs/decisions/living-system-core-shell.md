...
2. **住人自身が自身の住む系を観察し操作できる**（自己言及的構造）。住人の身体と環境を同じ MCP tool 群で公開し、住人が自分の手で読み・変える。user も同じ tool に手を伸ばす。詳細は `docs/philosophy/SELF_REFERENTIAL_MCP.ja.md`
...
- `docs/philosophy/SELF_REFERENTIAL_MCP.ja.md` — 自己言及的構造の詳細
