...
- 2026-06-10: 「event → state mutation axis は対象外」条項の具体化として生理反射層（startle / 注意切替 / settle）を Body built-in に追加。persona reaction との線引きは [physiological-reflex-layer.md](physiological-reflex-layer.md) に記録
