...
- bundled charminal-default の reflex を発火させたい新規 motion は、persona の `customTriggers` に直接書く
...
- [docs/philosophy/INHABITED_INTERFACE_PHILOSOPHY.md](../philosophy/INHABITED_INTERFACE_PHILOSOPHY.md)「多人格の住人」 — persona = agent の正当化
