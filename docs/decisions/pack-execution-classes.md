...
| `scene` (R3F component) | bundled-only | `trusted-main-thread-js`。user pack 対応は別 spec | main thread React + Three.js context。R3F host integration 必須。Internal design-record: specs/2026-05-03-scene-pack-r3f-component.md §5.5 |
