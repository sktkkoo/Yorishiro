...
- [**active-secondary-response.md**](active-secondary-response.md) — 外力よろめきは MotionScheduler と直交する additive channel。VRM 非依存の `packages/yoromeki` と Body の二地点 hook で、再生中 motion の上へ一度だけ合成する
