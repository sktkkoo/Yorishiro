...
- [**gpt-live-work-status-ledger.md**](gpt-live-work-status-ledger.md) — GPT Live は会話と進捗説明、Main Agent は実行、host-owned Work Status Ledger は安定 work ID と決定論的状態遷移を担当。raw log・approval ownership・thread targeting は持ち込まない
