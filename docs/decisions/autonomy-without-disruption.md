...
- 銃を撃ってターミナルの文字を物理崩壊させる演出は **Yorishiro の起源としての事実** として PHILOSOPHY.ja.md「起源」「発見」節に残す
...
「邪魔になりうることが presence の根拠」という旧立場は、Yorishiro を「user の作業の妨害装置」として位置づけかねない。Yorishiro の目的は user の作業を支えながら住人と過ごせる場を作ることであって、邪魔そのものではない。
...
**却下理由**：本末転倒。user の作業体験への直接的な悪影響。Yorishiro を「面白いが邪魔なプロダクト」として位置づけてしまう。
...
- 既存ユーザー pack で同種の作業破壊系演出を作る道は塞がない（Yorishiro 本体として推奨しないだけ）
