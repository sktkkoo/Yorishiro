...
- 同じ「pack」でも：
  - **persona / amenity**: runtime-active、event 駆動
...
- ✅ PersonaContext / AmenityContext / EffectContext は別型（共通基底クラスを作っていない）
...
- 関連: [`critical-constraints.md`](critical-constraints.md) §2 Amenity motion-free（型レベル境界の例）
