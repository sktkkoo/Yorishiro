...
| 種類 | 何をする | 例 |
|---|---|---|
| **persona** | キャラクターの性格・反応・身体・声・空間を定義（md-first、manifest.json + persona.md + minimal persona.js） | yori |
...
3. journal のいくつかの具体的な思い出に触れながら、今の住人の声でお別れを言う。長さは 200〜400 字ほど——読み上げるとおよそ 30〜60 秒になる。時間はあくまで目安
