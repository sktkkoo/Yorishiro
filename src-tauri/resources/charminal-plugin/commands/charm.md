...
2. **既存の pack を読む** — pattern と文体を踏襲する（cwd が Charminal repo なら `bundled-packs/` と `docs/design-record/dry-run/reference-packs/`）
...
- `docs/CHARMINAL.md` — 思想的背景（迷ったらここに戻る）
- `docs/design-record/2026-04-11-design-exploration.md` — 設計判断のログ
- `docs/design-record/dry-run/reference-packs/` — 書き方の実例（night-owl / error-notifier / diff-keeper / subtle-sparkle 等）
